...
export const icons = {
  ...
  image: svg('<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9" r="1.5"/><path d="m21 15-5-5L5 20"/>'),
  ...
  transfer: svg('<path d="M4 7h11M11 4l4 3-4 3M20 17H9M13 14l-4 3 4 3"/>'),
  repeat: svg('<path d="M17 2v5h-5M7 22v-5h5M20 11a8 8 0 0 0-13.7-5.7L4 7M4 13a8 8 0 0 0 13.7 5.7L20 17"/>'),
  scan: svg('<path d="M4 8V5a1 1 0 0 1 1-1h3M20 8V5a1 1 0 0 0-1-1h-3M4 16v3a1 1 0 0 0 1 1h3M20 16v3a1 1 0 0 1-1 1h-3"/><path d="M9 9h1v6H9zm5 0h1v6h-1zm-3 0h2v6h-2z"/>'),
